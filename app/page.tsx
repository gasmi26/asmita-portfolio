...
const projects = [
  {
    ...
    emoji: "📇",
    title: "ContactCraft",
    desc: "Full-stack contact management platform built with Spring Boot MVC and Thymeleaf. Features complete CRUD operations, CSV/Excel export, real-time chat, and secure OAuth2 login with Google & GitHub. Validated with Apache JMeter — achieved ~13ms response time, ~77 req/sec, 0% error rate.",
  ...
  },
  {
    ...
    desc: "AI procurement agent that predicts 4-week SKU-level demand using Amazon Chronos-T5, retrieves real-time market intelligence via a FAISS + LangChain RAG pipeline, and mathematically minimizes procurement costs using Linear Programming (PuLP) — all orchestrated by a LangGraph critic feedback loop.",
    stack: ["Python", "LangGraph", "LangChain", "FAISS", "Chronos-T5", "PuLP", "Flask", "React", "SQLite"],
